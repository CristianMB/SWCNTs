...
Abs= [rootpath,'Absorption14022025_AHC\SWCNT_All.csv'];
...
DATA_Absorption14022025_AHC.SWNTREF_fracB = FilterSingleSpectrum(DATA_Absorption14022025_AHC.SWNTREF_fracB, 175, 2500)
DATA_Absorption14022025_AHC.SWNTREF_fracC = FilterSingleSpectrum(DATA_Absorption14022025_AHC.SWNTREF_fracC, 175, 2500)
DATA_Absorption14022025_AHC.SWNTBiTeI_fracB = FilterSingleSpectrum(DATA_Absorption14022025_AHC.SWNTBiTeI_fracB, 175, 2500)
DATA_Absorption14022025_AHC.SWNTBiTeI_fracC = FilterSingleSpectrum(DATA_Absorption14022025_AHC.SWNTBiTeI_fracC, 175, 2500)

DATA_Absorption14022025_AHC.SWNTREF_fracB.Y = DATA_Absorption14022025_AHC.SWNTREF_fracB.Y - 0.44*3*DATA_References.Nicodenz.Y - 0.12*3*DATA_References.WaterInD2O.Y
DATA_Absorption14022025_AHC.SWNTREF_fracC.Y = DATA_Absorption14022025_AHC.SWNTREF_fracC.Y - 0.54*3*DATA_References.Nicodenz.Y - 0.05*3*DATA_References.WaterInD2O.Y
DATA_Absorption14022025_AHC.SWNTBiTeI_fracB.Y = DATA_Absorption14022025_AHC.SWNTBiTeI_fracB.Y - 0.47*3*DATA_References.Nicodenz.Y - 0.1*3*DATA_References.WaterInD2O.Y
DATA_Absorption14022025_AHC.SWNTBiTeI_fracC.Y = DATA_Absorption14022025_AHC.SWNTBiTeI_fracC.Y - 0.54*3*DATA_References.Nicodenz.Y - 0.05*3*DATA_References.WaterInD2O.Y
...
All = {
        DATA_Absorption14022025_AHC.SWNTBiTeI_fracB
        DATA_Absorption14022025_AHC.SWNTBiTeI_fracC
        DATA_Absorption14022025_AHC.SWNTREF_fracB
        DATA_Absorption14022025_AHC.SWNTREF_fracC
       
    };

All = Normalize(All,400, 700,'I'); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function filteredSample = FilterSingleSpectrum(sample, xMin, xMax)
    % FilterSingleSpectrum filters a single spectrum's data to include only the points within the specified X-range.
    %
    % Inputs:
    %   - sample: Structure with fields 'X' and 'Y'.
    %   - xMin: The minimum value of X to include in the filtered data.
    %   - xMax: The maximum value of X to include in the filtered data.
    % Outputs:
    %   - filteredSample: Structure with filtered 'X' and 'Y' values within the range [xMin, xMax].

    % Find the indices of X-values within the specified range
    validIndices = sample.X >= xMin & sample.X <= xMax;
    
    % Filter the data based on valid indices
    filteredSample = sample;
    filteredSample.X = sample.X(validIndices);
    filteredSample.Y = sample.Y(validIndices);
end
