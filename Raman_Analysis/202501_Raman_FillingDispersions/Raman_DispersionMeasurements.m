...
DATA_20250131.KITL514G.N='KIT Converted - 10x45s';
DATA_20250131.KITL514R.N='KIT Converted - 10x60s';
DATA_20250131.KT3L514G.N='KIT Converted - 30x30s';
DATA_20250131.KT5L514G.N='KIT Converted - 20x5s';
DATA_20250131.KTLL514G.N='KIT Converted - 20x15s';
DATA_20250131.KTLL514R.N='KIT Converted - 20x10s';

%%%--------MANUAL CORRECTIONS--------%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%--------SAMPLE COMPARISION--------%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% KIT Converted Sample - Dispersion Labeled 'T6 SWCNTs Converted Megasonicated'
               
R = {
        DATA_20250131.KITL514R
        DATA_20250131.KTLL514R         
    };   
     
G = {   DATA_20250131.KITL514G
        DATA_20250131.KTLL514G
        DATA_20250131.KT3L514G
        DATA_20250131.KT5L514G
    };   
% 
...
G = SubstractLinearBG(G, 1260, 1675)
...
LLines = {
    DATA_20250131.LL514A
    DATA_20250131.LL514B
    DATA_20250131.LL514C
    DATA_20250131.LL514D
};

% LLines = NormalizeSample(LLines, 0, 3000);
% plotRaman(LLines,0)
