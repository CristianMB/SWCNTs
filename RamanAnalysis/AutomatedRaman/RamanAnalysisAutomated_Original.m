...
RBMregion_Low=150; % Lower limit in cm-1
RBMregion_High=350; % Upper limit in cm-1
Prom=[0.01;0.1 ]; % This value sets the max limit at which peaks will be considered. 
...
findpeaks(Intensity_norm(indRBMLow:indRBMHigh,n),Shift(indRBMLow:indRBMHigh),'MinPeakProminence',Prom(z))
...
[pksRBM,locsRBM]=findpeaks(Intensity_norm(indRBMLow:indRBMHigh,n),Shift(indRBMLow:indRBMHigh),'MinPeakProminence',Prom(z));
